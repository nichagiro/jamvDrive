...
const baseClasses =
  "rounded-lg text-21 font-medium py-2 px-7 transition-colors duration-200 z-50 cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50";
